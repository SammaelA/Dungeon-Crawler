...
public:
    ...
    void OnUpdate() override;
    static void Attack(ecs::IEntity *creature,CompDamage *damage,sf::Color color);
};
...
class GameTickSys : public ecs::System 
{
public:
    ECS_SYSTEM_DEFAULTS(GameTickSys)
    void OnUpdate() override;
};
...
ECS_REGISTER_SYSTEM(GameTickSys)